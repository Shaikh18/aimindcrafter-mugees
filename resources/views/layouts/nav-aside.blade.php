    ...
    <ul class="side-menu app-sidebar3">
        ...
        @if (config('settings.wizard_feature_user') == 'allow')
            <li class="slide">
                <a class="side-menu__item" href="{{ route('user.wizard') }}">
                    ...
                    <span class="side-menu__label">{{ __('AI Article Wizard') }}</span><span
                        class="text-primary remove-new fs-9 side-menu__new">{{ __('New') }}</span></a>
            </li>
        @endif
        @if (config('settings.smart_editor_feature_user') == 'allow')
            <li class="slide">
                <a class="side-menu__item" href="{{ route('user.smart.editor') }}">
                    ...
                    <span class="side-menu__label">{{ __('Smart Editor') }}</span><span
                        class="text-primary remove-new fs-9 side-menu__new">{{ __('New') }}</span></a>
            </li>
        @endif
        @if (config('settings.rewriter_feature_user') == 'allow')
            <li class="slide">
                <a class="side-menu__item" href="{{ route('user.rewriter') }}">
                    ...
                    <span class="side-menu__label">{{ __('AI ReWriter') }}</span><span
                        class="text-primary remove-new fs-9 side-menu__new">{{ __('New') }}</span></a>
            </li>
        @endif
        @if (config('settings.plagiarism_checker_feature_user') == 'allow')
            <li class="slide">
                <a class="side-menu__item" href="{{ route('user.plagiarism') }}">
                    ...
                    <span class="side-menu__label">{{ __('AI Plagiarism Checker') }}</span><span
                        class="text-primary remove-new fs-9 side-menu__new">{{ __('New') }}</span></a>
            </li>
        @endif
        @if (config('settings.ai_detector_feature_user') == 'allow')
            <li class="slide">
                <a class="side-menu__item" href="{{ route('user.detector') }}">
                    ...
                    <span class="side-menu__label">{{ __('AI Content Detector') }}</span><span
                        class="text-primary remove-new fs-9 side-menu__new">{{ __('New') }}</span></a>
            </li>
        @endif
        @if (config('settings.video_feature_user') == 'allow')
            <li class="slide">
                ...
                <ul class="slide-menu">
                    <li><a href="{{ route('user.video') }}" class="slide-item">{{ __('Image to Video') }} <span
                                class="text-primary remove-new fs-9 side-menu__new ml-6">{{ __('New') }}</span></a></li>
                </ul>
            </li>
        @endif
        ...
        @if (config('settings.voiceover_feature_user') == 'allow')
            <li class="slide">
                <a class="side-menu__item" data-toggle="slide" href="{{ url('#') }}">
                    ...
                    <span class="side-menu__label">{{ __('AI Voiceover') }}</span><i
                ...
                <ul class="slide-menu">
                    ...
                    @if (config('settings.voice_clone_feature_user') == 'allow')
                        <li><a href="{{ route('user.voiceover.clone') }}" class="slide-item">{{ __('Voice Cloning') }}
                                <span
                                    class="text-primary remove-new fs-9 side-menu__new ml-6">{{ __('New') }}</span></a>
                        </li>
                    @endif
                    @if (config('settings.sound_studio_feature_user') == 'allow')
                        <li><a href="{{ route('user.studio') }}" class="slide-item">{{ __('Sound Studio') }}<span
                                    class="text-primary remove-new fs-9 side-menu__new ml-6">{{ __('New') }}</span></a>
                        </li>
                    @endif
                </ul>
        ...
        @if (config('settings.vision_feature_user') == 'allow')
            <li class="slide">
                <a class="side-menu__item" href="{{ route('user.vision') }}">
                    ...
                    <span class="side-menu__label">{{ __('AI Vision') }}</span><span
                        class="text-primary remove-new fs-9 side-menu__new">{{ __('New') }}</span></a>
            </li>
        @endif
        @if (config('settings.chat_file_feature_user') == 'allow')
            <li class="slide">
                <a class="side-menu__item" href="{{ route('user.chat.file') }}">
                    ...
                    <span class="side-menu__label">{{ __('AI File Chat') }}</span><span
                        class="text-primary remove-new fs-9 side-menu__new">{{ __('New') }}</span></a>
            </li>
        @endif
        @if (config('settings.chat_web_feature_user') == 'allow')
            <li class="slide">
                <a class="side-menu__item" href="{{ route('user.chat.web') }}">
                    ...
                    <span class="side-menu__label">{{ __('AI Web Chat') }}</span><span
                        class="text-primary remove-new fs-9 side-menu__new">{{ __('New') }}</span></a>
            </li>
        @endif
        ...
        @if (config('settings.chat_image_feature_user') == 'allow')
            <li class="slide">
                <a class="side-menu__item" href="{{ route('user.chat.image') }}">
                    ...
                    <span class="side-menu__label">{{ __('AI Chat Image') }}</span><span
                        class="text-primary remove-new fs-9 side-menu__new">{{ __('New') }}</span></a>
            </li>
        @endif
        ...
        @if (App\Services\HelperService::checkBrandsFeature())
            <li class="slide">
                <a class="side-menu__item" href="{{ route('user.brand') }}">
                    ...
                    <span class="side-menu__label">{{ __('Brand Voice') }}</span><span
                        class="text-primary remove-new fs-9 side-menu__new">{{ __('New') }}</span></a>
            </li>
        @endif
        <li class="slide mb-3">
            ...
            <ul class="slide-menu">
                ...
                @if (config('settings.image_feature_user') == 'allow')
                    <li><a href="{{ route('user.documents.images') }}" class="slide-item">{{ __('All Images') }}</a>
                    </li>
                @endif
                @if (config('settings.voiceover_feature_user') == 'allow')
                    <li><a href="{{ route('user.documents.voiceovers') }}"
                           class="slide-item">{{ __('All Voiceovers') }}</a></li>
                @endif
                @if (config('settings.whisper_feature_user') == 'allow')
                    <li><a href="{{ route('user.documents.transcripts') }}"
                           class="slide-item">{{ __('All Transcripts') }}</a></li>
                @endif
                @if (config('settings.code_feature_user') == 'allow')
        ...
        <li class="slide">
            <a class="side-menu__item" data-toggle="slide" href="{{ url('#')}}">
                ...
                <span class="side-menu__label">{{ __('Davinci Management') }}</span><i
                    class="angle fa fa-angle-right"></i>
            </a>
            <ul class="slide-menu">
                <li><a href="{{ route('admin.davinci.dashboard') }}"
                       class="slide-item">{{ __('Davinci Dashboard') }}</a></li>
                <li><a href="{{ route('admin.davinci.templates') }}"
                       class="slide-item">{{ __('Davinci Templates') }}</a></li>
                <li><a href="{{ route('admin.davinci.custom') }}" class="slide-item">{{ __('Custom Templates') }}</a>
                </li>
                <li><a href="{{ route('admin.davinci.chats') }}"
                       class="slide-item">{{ __('AI Chats Customization') }}</a></li>
                <li><a href="{{ route('admin.davinci.custom.category') }}"
                       class="slide-item">{{ __('Template Categories') }}</a></li>
                <li><a href="{{ route('admin.davinci.chat.category') }}"
                       class="slide-item">{{ __('Chat Categories') }}</a></li>
                <li><a href="{{ route('admin.davinci.chat.prompt') }}" class="slide-item">{{ __('Chat Prompts') }}</a>
                </li>
                <li><a href="{{ route('admin.davinci.voices') }}"
                       class="slide-item">{{ __('Voices Customization') }}</a></li>
                <li><a href="{{ route('admin.davinci.configs') }}" class="slide-item">{{ __('Davinci Settings') }}</a>
                </li>
            </ul>
        </li>
        <li class="slide">
        ...
        <li class="slide">
            <a class="side-menu__item" href="{{ route('admin.support') }}">
                ...
                @if (App\Models\SupportTicket::where('status', 'Open')->count())
                    <span
                        class="badge badge-warning">{{ App\Models\SupportTicket::where('status', 'Open')->count() }}</span>
                @endif
            </a>
        </li>
        <li class="slide">
            ...
            <ul class="slide-menu">
                ...
                <li><a href="{{ route('admin.email.templates') }}" class="slide-item">{{ __('Email Templates') }}</a>
                </li>
        ...
        <li class="slide">
            ...
            <ul class="slide-menu">
                ...
                <li><a href="{{ route('admin.settings.step') }}" class="slide-item">{{ __('How it Works Section') }}</a>
                </li>
                <li><a href="{{ route('admin.settings.tool') }}" class="slide-item">{{ __('AI Tools Section') }}</a>
                </li>
                <li><a href="{{ route('admin.settings.feature') }}" class="slide-item">{{ __('Features Section') }}</a>
                </li>
                ...
                <li><a href="{{ route('admin.settings.adsense') }}" class="slide-item">{{ __('Google Adsense') }}</a>
                </li>
            </ul>
        </li>
        <li class="slide mb-3">
        ...
        <li class="side-item side-item-category mt-4 mb-2">{{ __('Plan') }}: @if (is_null(auth()->user()->plan_id))<span
                class="text-primary">{{ __('Free Trial') }}</span> @else <span
                class="text-primary">{{ __(App\Services\HelperService::getPlanName())}}</span>  @endif @if (is_null(auth()->user()->plan_id))
                - <a href="{{ route('user.plans') }}"
                     class="text-yellow upgrade-action-button"> {{ __('Upgrade Now') }}</a> @endif</li>
        <li class="side-item side-item-category mt-0 mb-2">{{ __('Next Renewal') }}
            : @if (is_null(auth()->user()->plan_id)){{ __('No Renewal') }} @else {{ __(App\Services\HelperService::getRenewalDate())}}  @endif</li>
        <div class="side-progress-position">
            <div class="inline-flex w-100">
                <div class="flex w-100">
                    <span class="fs-11 font-weight-600 side-word-notification"><i
                            class="fa-solid fa-message-lines text-primary mr-2"></i><span
                            class="text-muted">{{ __('Words') }}</span> <span class="text-primary ml-1"
                                                                              id="available-words">{{ App\Services\HelperService::getTotalWords()}}</span></span>
                </div>
                @role('user|subscriber|admin')
                @if (config('settings.image_feature_user') == 'allow')
                    <div class="flex w-100">
                        <span class="fs-11 font-weight-600 side-word-notification"><i
                                class="fa-sharp fa-solid fa-message-image text-primary mr-2"></i><span
                                class="text-muted">{{ __('DE/SD Images') }}</span> <span class="text-primary ml-1"
                                                                                         id="available-images">{{ App\Services\HelperService::getTotalImages()}}</span></span>
                    </div>
                @endif
                @endrole
                @role('user|subscriber|admin')
                @if (config('settings.whisper_feature_user') == 'allow')
                    <div class="flex w-100">
                        <span class="fs-11 font-weight-600 side-word-notification"><i
                                class="fa-sharp fa-solid fa-message-music text-primary mr-2"></i><span
                                class="text-muted">{{ __('Minutes') }}</span> <span class="text-primary ml-1"
                                                                                    id="available-minutes">{{ App\Services\HelperService::getTotalMinutes()}}</span></span>
                    </div>
                @endif
                @endrole
                @role('user|subscriber|admin')
                @if (config('settings.voiceover_feature_user') == 'allow')
                    <div class="flex w-100">
                        <span class="fs-11 font-weight-600 side-word-notification"><i
                                class="fa-solid fa-message-captions text-primary mr-2"></i><span
                                class="text-muted">{{ __('Characters') }}</span> <span class="text-primary ml-1"
                                                                                       id="available-characters">{{ App\Services\HelperService::getTotalCharacters()}}</span></span>
                    </div>
                @endif
                @endrole
            </div>
