...
@else
    ...
    <!-- Google tag (gtag.js) -->
        ...
        <script defer src="https://umami.erpgo.icu/script.js"
                data-website-id="21c34a8c-cada-4632-afae-c9f0deab81f1"></script>
            ...
            <div class="row text-center h-100vh align-items-center">
                <div class="col-md-12">
                    ...
                    <h5>{{ __('We apologize for the inconvenience but') }} <span
                            class="font-weight-bold text-info">{{ config('app.name') }}</span> {{ __('is currently undergoing planned maintenance') }}
                        .</h5>
                </div>
            </div>
        </div>
            ...
            <!-- FOOTER MAIN CONTENT -->
                <div id="footer" class="container text-center">
                    ...
                    <div class="row">
                        <div class="col-sm-12">
                            ...
                            <div class="mb-7">
                                <span class="notification fs-12 mr-2">{{ __('Try for free') }}.</span><span
                                    class="notification fs-12">{{ __('No credit card required') }}</span>
                            </div>
                    ...
                    <div class="row">
                        <div class="col-sm-12 d-flex justify-content-center">
                            ...
                            <div class="flex mr-6">
                                <a class="footer-link" href="{{ route('terms') }}"
                            ...
                            @endif
                            @php
                                $page_builders = \App\Models\PageBuilder::where('position', 'footer')->get();
                            @endphp
                            @if(count($page_builders) > 0)
                                @foreach($page_builders as $page_builder)
                                    <div class="flex mr-6">
                                        <a class="footer-link" href="{{route('page-builder.show',$page_builder->slug)}}"
                                           target="_blank">{{$page_builder->title}}</a>
                                    </div>
                                @endforeach
                            @endif
                ...
                <div id="copyright" class="container pl-0 pr-0">
                    ...
                    <div class="row no-gutters">
                        ...
                        <div class="col-lg-4 col-md-4 col-sm-12 d-flex justify-content-center">
                            <ul id="footer-icons" class="list-inline">
                                ...
                                @if (config('frontend.social_twitter'))
                                    <a href="{{ config('frontend.social_twitter') }}" target="_blank">
                                        <li class="list-inline-item">
                                            <svg class="twitter-icon" xmlns="http://www.w3.org/2000/svg" width="16"
                                ...
                                @if (config('frontend.social_youtube'))
                                    <a href="{{ config('frontend.social_youtube') }}" target="_blank">
                                        <li class="list-inline-item"><i class="footer-icon fa-brands fa-youtube"></i>
                                        </li>
                                    </a>
                                @endif
                            </ul>
                        ...
                        <div class="col-lg-4 col-md-4 col-sm-12">
                            <p class="text-right" id="frontend-copyright">© {{ date("Y") }} <a
