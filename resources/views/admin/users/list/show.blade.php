						...
						<div class="col-sm-12 border-bottom">
							<div class="text-center p-2">
								<div class="d-flex w-100">
									...
									<div class="flex w-100">
										<h4 class="mb-3 mt-3 font-weight-800 fs-16">@if ($user->available_dalle_images == -1) {{ __('Unlimited') }} @else {{ number_format($user->available_dalle_images + $user->available_dalle_images_prepaid + $user->available_sd_images + $user->available_sd_images_prepaid) }} @endif</h4>
										<h6 class="fs-12 mb-3">{{ __('DE/SD Images Left') }}</h6>
									</div>	
								</div>	
								<div class="d-flex w-100">
									<div class="flex w-100">
