		...
		<div class="col-lg-6 col-md-6 col-xm-12">
			<div class="card border-0">
				...
				<div class="card-body pt-5">		
					...
					<div class="row pt-5">
						<div class="col-lg-4 col-md-4 col-12">
							<h6 class="font-weight-bold mb-1">{{ __('Included Dalle Images') }}: </h6>
							<span class="fs-14">{{ number_format($id->dalle_images) }}</span>
						</div>
						<div class="col-lg-4 col-md-4 col-12">
							<h6 class="font-weight-bold mb-1">{{ __('Included SD Images') }}: </h6>
							<span class="fs-14">{{ number_format($id->sd_images) }}</span>
						</div>
						<div class="col-lg-4 col-md-4 col-12">
