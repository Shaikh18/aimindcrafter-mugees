			...
			<div class="card overflow-hidden border-0">
				...
				<div class="card-body pt-5">		
					...
					<div class="border-0 text-center mb-2 mt-8">
						<a href="<?php echo e(route('admin.notifications.system')); ?>" class="btn btn-primary pl-7 pr-7"><?php echo e(__('Return')); ?></a>
					</div>
				</div>
			</div>
		</div>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/ns1wjmaq/domains/aimindcrafter.com/public_html/resources/views/admin/notification/systemShow.blade.php ENDPATH**/ ?>